...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "cak" => "yangmengyu.cak@bytedance.com" }
  # Or just: spec.author    = "cak"
  # spec.authors            = { "cak" => "yangmengyu.cak@bytedance.com" }
  # spec.social_media_url   = "https://twitter.com/cak"
